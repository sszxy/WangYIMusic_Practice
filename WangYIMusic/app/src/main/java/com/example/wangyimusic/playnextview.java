...
public class playnextview extends View {
    Paint paint;
    ...
    public playnextview(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public playnextview(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
