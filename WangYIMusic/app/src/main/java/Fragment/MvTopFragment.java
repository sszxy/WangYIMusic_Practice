...
import com.example.wangyimusic.MainActivity;
...
public class MvTopFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        Log.d("tag", "create");
        rootView = inflater.inflate(R.layout.mv_top_fragment, container, false);
        mv_fount_rcl= rootView.findViewById(R.id.mv_top_rcl);
        return rootView;
    }
    ...
    private void initData() {
        String mvFoundaddress="https://api.itooi.cn/music/tencent/hotMvList?key=579621905&year=0&tag=0&area=0&limit=10&offset=0";
